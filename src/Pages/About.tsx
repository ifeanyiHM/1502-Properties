...
function About() {
  return (
    <div className="about">
      ...
      <div className="body">
        <h2>
          Phoenix Global Properties, a distinguished force in the real estate
          industry, seamlessly integrates expertise with innovative solutions.
          As we embark on rewriting our future, let's explore how we stand at
          the forefront, offering unparalleled services that redefine the real
          estate experience.
        </h2>
        ...
        <div className="long-lease-developement">
          ...
          <p>
            Phoenix Global Properties extends its services to long-term leasing
        ...
        <div className="property-valuation">
          ...
          <p>
            ...
            Phoenix Global Properties, we employ industry-leading methods to
            provide precise and comprehensive property valuation services. Our
        ...
        <div className="property-finance">
          ...
          <p>
            {" "}
            Understanding the financial intricacies of real estate, Phoenix
            Global Properties offers tailored property finance solutions. We
            empower our clients to make strategic financial decisions, ensuring
            that their investments align with their long-term goals.
          </p>
        </div>
        ...
        <div className="three-fold-approach">
          ...
          <p>
            At Phoenix Global Properties, our three-fold approach defines our
            commitment to clients: expertise, a client-centric approach, and an
            innovative wealth of knowledge. We bring seasoned professionals to
            the table, ensuring expert guidance for your real estate endeavors.
          </p>
        </div>
        <div className="excellence-in-action">
          ...
          <p>
            ...
            client satisfaction. Phoenix Global Properties sets new standards,
        ...
        <div className="staying-ahead">
          ...
          <p>
            In an industry characterized by constant change, Phoenix Global
            Properties remains at the forefront by staying ahead of market
            trends. Our proactive approach involves continuous research,
            analysis, and adaptation to emerging patterns, ensuring our clients
            benefit from the most up-to-date information.
          </p>
        </div>
        <div className="trusted-partner">
          <h3>Phoenix Global Properties as a Trusted Partner</h3>
          <p>
        ...
        <div className="evolving-with-landscape">
          ...
          <p>
            ...
            Join us at Phoenix Global Properties, where your real estate
            aspirations meet unparalleled expertise and innovation. As a brand,
            we convey not just professionalism but passion and dedication. We're
            not just a real estate service provider; we're your partners in
            success. Building trust through an emotional connection, we invite
            you to experience the Phoenix Global Properties difference. In
            summary, Phoenix Global Properties transcends traditional real
            estate services. Our commitment to excellence, a client-centric
            approach, and staying ahead of market trends define us. Join us on
            this journey where your aspirations meet expertise and innovation.
          </p>
        </div>
      </div>
    </div>
